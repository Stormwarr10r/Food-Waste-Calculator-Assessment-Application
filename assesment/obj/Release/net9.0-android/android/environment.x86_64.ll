...
@aot_dso_cache = dso_local local_unnamed_addr global [828 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-System.Diagnostics.DiagnosticSource.dll.so
		ptr null; void* handle
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1c2264a7319a81e5, ; from name: libaot-assesment
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	}, ; 96
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3d4c18671b1d477b, ; from name: aot-assesment.dll.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x426c3a20302d1977, ; from name: assesment
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x48498412ca2f66c4, ; from name: aot-assesment
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7b3d7f2a4acfdfde, ; from name: libaot-assesment.dll.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8d686ec184bb1929, ; from name: assesment.dll.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd14380a01c2c3360, ; from name: libaot-assesment.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd52c6143b9616648, ; from name: assesment.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf1fb46842e5ddbd6, ; from name: aot-assesment.so
		i64 u0x7b3d7f2a4acfdfde, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-assesment.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.assesment\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [24 x i8] c"libaot-assesment.dll.so\00", align 16
...
@.DSOCacheEntry.29_name = private unnamed_addr constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 16
